package com.eafit.tutorial.products_api.service.impl;
...
import com.eafit.tutorial.products_api.repository.ProductRepository;
...
public class ProductServiceImpl implements ProductService {
    ...
    public Product updateProduct(Long id, UpdateProductDTO dto) {
        ...
        if (!existingProduct.getName().equalsIgnoreCase(dto.getName()) &&
                productRepository.existsByNameIgnoreCaseAndIdNot(dto.getName(), id)) {
            throw new ProductAlreadyExistsException("Ya existe otro producto con el nombre: " + dto.getName());
        }
