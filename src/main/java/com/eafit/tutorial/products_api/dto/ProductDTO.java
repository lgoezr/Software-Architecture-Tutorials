package com.eafit.tutorial.products_api.dto;
...
/**
 * DTO para Product - usado en respuestas de la API.
 * 
...
public class ProductDTO {
    ...
    @Schema(description = "Fecha de creación", example = "2024-01-15 10:30:00")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
    private LocalDateTime createdAt;

    @Schema(description = "Fecha de última actualización", example = "2024-01-16 14:20:00")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
